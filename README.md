...
Let **T = 2**, learning rate $\eta = 0.5$. We use **decision stumps** as weak learners.
...
| 6 | -1 | 0 | -1 |
 ...
 - Build First Tree $h_1$ with output as Residuals

| Sample $i$ | True Label $y_i$ | $F_0(x_i)$ | Residual $r_i = y_i - F_0(x_i)$ | Prediction $h_1(x_i)$ |
|------------|-----------------|------------|-------------------|-----------------------|
| 1 | +1 | 0 | +1 | +1 |
| 2 | +1 | 0 | +1 | +1 |
| 3 | -1 | 0 | -1 | -1 |
...
| Sample $i$ | True Label $y_i$ | $F_0(x_i)$ | Residual $r_i = y_i - F_0(x_i)$ | Prediction $h_1(x_i)$ | $F_1(x_i) = F_0(x) + \eta h_1(x)$ | Residual $r_i  = y_i - F_1(x_i) $ | Prediction $h_2(x_i)$ |
|------------|------------------|------------|---------------------------------|-----------------------|------------|-----------------------------------|-----------------------|
| 1 | +1 | 0 | +1 | +1 | +0.5 | +0.5 | +1 |
| 2 | +1 | 0 | +1 | +1 | +0.5 | +0.5 | +1 |
| 3 | -1 | 0 | -1 | -1 | -0.5 | -0.5 | -1 |
...
$$
F_2(x) = F_0(x) + \eta h_1(x) + \eta h_2(x)
$$


| Sample $i$ | $F_1(x_i)$ | $h_2(x_i)$ | $F_2(x_i)$ |
|------------|------------|------------|------------|
| 1 | +0.5 | +1 | (+0.5) + 0.5 * (+1) = 1.0 |
| 2 | +0.5 | +1 | (+0.5) + 0.5 * (+1) = 1.0 |
| 3 | -0.5 | -1 | (-0.5) + 0.5 * (-1) = -1.0 |
| 4 | +0.5 | +1 | (+0.5) + 0.5 * (+1) = 1.0 |
| 5 | -0.5 | -1 | (-0.5) + 0.5 * (-1) = -1.0 |
| 6 | -0.5 | -1 | (-0.5) + 0.5 * (-1) = -1.0 |


- Final Prediction

| Sample $i$ | True Label $y_i$ | $F_2(x_i)$ | Predicted Class |
|------------|-----------------|------------|----------------|
| 1 | +1 | 1.0 | +1 |
| 2 | +1 | 1.0 | +1 |
| 3 | -1 | -1.0 | -1 |
